        ...
        ${user.pictures.map(function (picture) {
          return yo`<div class="col s12 m6 l4">
            <div class="picture-container">
              <img src="${picture.src}" class="picture materialboxed" data-caption="${translate('likes', { likes: picture.likes })}" />
            ...
            <div id="modal${picture.id}" class="modal modal-fixed-footer">
              ...
              <div class="modal-footer">
                <div class="btn btn-flat likes" >
                  <i class="fas fa-heart"></i> ${translate('likes', { likes: picture.likes })}
                </div>
              </div>
            </div>
          </div>`;
